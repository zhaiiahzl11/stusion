    ...
    <div class="grid grid-cols-4 gap-4">
        <a href="/admin/schedule" class="block bg-white rounded-xl border border-gray-100 shadow-sm cursor-pointer hover:border-[#f48545]/50 hover:bg-[#fff9f6] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div class="p-4">
                ...
                <p class="text-2xl font-bold text-gray-900 mt-2">{{ $totalSessions > 0 ? $totalSessions : '0' }}</p>
                <p class="text-xs text-gray-400 mt-1">From counseling_sessions</p>
            </div>
        </a>
        <a href="/admin/schedule" class="block bg-white rounded-xl border border-gray-100 shadow-sm cursor-pointer hover:border-[#f48545]/50 hover:bg-[#fff9f6] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div class="p-4">
                <p class="text-sm font-medium text-gray-500">Pending Requests</p>
                <p class="text-2xl font-bold text-gray-900 mt-2">{{ $pendingRequestsCount > 0 ? $pendingRequestsCount : '0' }}</p>
                <p class="text-xs text-gray-400 mt-1">From session_requests</p>
            </div>
        </a>
        <a href="/admin/users" class="block bg-white rounded-xl border border-gray-100 shadow-sm cursor-pointer hover:border-[#f48545]/50 hover:bg-[#fff9f6] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div class="p-4">
                ...
                <p class="text-2xl font-bold text-gray-900 mt-2">{{ $activeCounselorsCount > 0 ? $activeCounselorsCount : '0' }}</p>
                <p class="text-xs text-gray-400 mt-1">From counselors table</p>
            </div>
        </a>
        <a href="/admin/users" class="block bg-white rounded-xl border border-gray-100 shadow-sm cursor-pointer hover:border-[#f48545]/50 hover:bg-[#fff9f6] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            <div class="p-4">
                <p class="text-sm font-medium text-gray-500">Students</p>
                <p class="text-2xl font-bold text-gray-900 mt-2">{{ $totalStudents > 0 ? $totalStudents : '0' }}</p>
    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm">
        ...
        <div class="p-6">
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-white border border-gray-100 rounded-xl hover:border-[#f48545]/30 hover:bg-[#fff9f6] transition-all shadow-sm shadow-gray-100/50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $req->student->name ?? 'Unknown Student' }}</p>
