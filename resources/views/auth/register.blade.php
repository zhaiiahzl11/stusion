...
<div class="min-h-screen w-full flex items-center justify-center p-6 sm:p-12 relative bg-[#5e3020]">
  ...
  <div class="bg-[#ebebeb] w-full max-w-[900px] rounded-[2rem] flex flex-col md:flex-row shadow-lg min-h-[440px] md:min-h-[500px]">
    ...
    <div class="flex flex-col justify-center px-10 py-12 md:px-16 md:py-16 w-full md:w-1/2">
      ...
      <!-- Form -->
      <form method="POST" action="/register" class="space-y-4 w-full pl-2">
        @csrf
        ...
        <div class="relative">
          ...
          <select name="role" class="w-full pl-12 pr-4 py-3 bg-[#f5f5f5] text-gray-800 text-xs font-semibold rounded-xl border-none focus:ring-2 focus:ring-[#ff883e] focus:outline-none appearance-none" required>
        ...
        <p class="text-center text-xs text-gray-500 font-semibold mt-4">
          Already have an account? <a href="/login" class="text-[#f48545] hover:text-[#e67a3b] ml-1 uppercase">Login</a>
        </p>
      </form>
    </div>
